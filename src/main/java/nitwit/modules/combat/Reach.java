            ...
            if (e.isPre()) {
                ...
                if (a = Client.settingsManager.getSettingByName("Misplace").getValBoolean()) {
                    for (final Object object : mc.theWorld.loadedEntityList) {
                        ...
                        if (mc.thePlayer.getDistanceToEntity(o) > Client.settingsManager
                                .getSettingByName("Reach").getValDouble()) {
                            continue;
                        }
                        ...
                        o.setPosition(oldX - mx / mc.thePlayer.getDistanceToEntity(o) * 1, oldY,
                                oldZ - mz / mc.thePlayer.getDistanceToEntity(o) * 1);
                    }
                } else {
